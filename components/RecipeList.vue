<template>
  <div class="container mx-auto">
    <ul class="flex flex-wrap justify-center gap-4">
      ...
      >
        <NuxtLink :to="`/recipes/${recipe.slug}`" class="group relative block">
          <NuxtImg
            class="relative"
            width="300"
            height="300"
            ...
            :src="
              ...
              '/images/recipes/featured-image-placeholder.jpg'
            "
            :alt="recipe.title"
          />
          <h3 class="mt-2 text-center text-xl">{{ recipe.title }}</h3>
          <!-- Hover overlay -->
          <div
