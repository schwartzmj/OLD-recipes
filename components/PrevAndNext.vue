<template>
  <div class="mx-auto flex max-w-lg items-center justify-between space-x-2">
    <div v-if="prev" class="text-center">
      <NuxtLink
        :to="prev.path"
        class="flex items-center justify-center bg-gradient-to-l from-stone-400 to-stone-600 p-2 text-stone-50 shadow-lg shadow-stone-400 hover:bg-gradient-to-bl"
      >
        <svg
    ...
    <div v-if="next" class="text-center">
      <NuxtLink
        :to="next.path"
        class="flex items-center justify-center bg-gradient-to-r from-stone-400 to-stone-600 p-2 text-stone-50 shadow-lg shadow-stone-400 hover:bg-gradient-to-br"
      >
